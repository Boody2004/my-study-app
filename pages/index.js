          ...
          <div className="container mx-auto px-5 sm:px-10">
            ...
            <div
              ...
              style={{
                background: "#EE9AE5",
                background:
                  " -webkit-linear-gradient(to right, #5961F9, #EE9AE5)",
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 p-8 sm:py-20 sm:px-28 lg:px-20">
                ...
                <div className="text-end max-w-xl text-white">
                  ...
                  <p className="text-xl mt-10 mb-5">
                    منصة دروس اون لاين هي منصة الي تعليم الطلاب من داية الصف
                    رياض اطفال الي الصف الثانوي العام
                    <br />
                    تتميز المنصة بي جودة الفديوهات و الكتب الدراسة الي الطالب و
                    افضل طرق الشرح المبسطة و جودة تنظيم و تقسيم المراحل الدراسة
                    للطلبة
                    <br />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div className="text-end max-w-xl grid content-center">
                  ...
                  <p className="text-xl mt-10 text-textPrimary">
                    كل الكتب الوزارة و الكتب الخارجية موجودة علي منصة دروس اون
                    لاين
                    <br />
                    هتتعلم اسرع و هتوفر وقت و مجهود
                  </p>
            ...
            <div className="my-40">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="text-end max-w-xl grid content-center">
                  ...
                  <p className="text-xl mt-10 text-textPrimary">
                    كل الفديوهات التعليمية و الفديوهات التعليمية ذات المصدر
                    المفتوح موجودة علي منصة دروس اون لاين <br />
                    هتتعلم اسرع و هتوفر وقت و مجهود
                  </p>
                </div>
              </div>
